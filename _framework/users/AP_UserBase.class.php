...
class AP_UserBase Extends AP_Base {
	...
	public function __set($strName, $mixValue) {
		switch ($strName) {
			...
			case 'FirstName': // TODO: Casing
				return ($this->objUser->data->first_name = $mixValue);
			case 'LastName': // TODO: Casing
				return ($this->objUser->data->last_name = $mixValue);
			case 'Meta':
			...
			case 'NiceName' :
				return ($this->objUser->data->user_nicename = $mixValue);
			case 'Name':
			...
			case 'Password' :;
				wp_set_password($mixValue, $this->ID);
				$this->objUser->data->user_pass = $mixValue;
				break;
		}
	}
	...
	public function Register(){
		...
		if($this->Login <> ''){
			echo "registering";
			print_r(array($this->Login, $this->Password, $this->Email));
			...
			wp_update_user($this->objUser->data);
