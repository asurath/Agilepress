...
class AP_DateTimeSpan {
	...
	*/
	...
	public function AddMinutes($intMinutes){
		$this->intSeconds = $this->intSeconds + ($intMinutes * AP_DateTimeSpan::SecondsPerMinute);
	}
	...
	public function AddHours($intHours){
		$this->intSeconds = $this->intSeconds + ($intHours * AP_DateTimeSpan::SecondsPerHour);
	}
	...
	public function AddDays($intDays){
		$this->intSeconds = $this->intSeconds + ($intDays * AP_DateTimeSpan::SecondsPerDay);
	}
	...
	public function AddMonths($intMonths){
		$this->intSeconds = $this->intSeconds + ($intMonths * AP_DateTimeSpan::SecondsPerMonth);
	}
	...
	*/
	...
	protected function GetYears() {
		$intSecondsPerYear = ($this->IsPositive()) ? AP_DateTimeSpan::SecondsPerYear : ((-1) * AP_DateTimeSpan::SecondsPerYear);
	...
	protected function GetMonths(){
		$intSecondsPerMonth = ($this->IsPositive()) ? AP_DateTimeSpan::SecondsPerMonth : ((-1) * AP_DateTimeSpan::SecondsPerMonth);
	...
	protected function GetDays(){
		$intSecondsPerDay = ($this->IsPositive()) ? AP_DateTimeSpan::SecondsPerDay : ((-1) * AP_DateTimeSpan::SecondsPerDay);
	...
	protected function GetHours(){
		$intSecondsPerHour = ($this->IsPositive()) ? AP_DateTimeSpan::SecondsPerHour : ((-1) * AP_DateTimeSpan::SecondsPerHour);
	...
	protected function GetMinutes(){
		$intSecondsPerMinute = ($this->IsPositive()) ? AP_DateTimeSpan::SecondsPerMinute : ((-1) * AP_DateTimeSpan::SecondsPerMinute);
	...
	*/
	...
	protected function GetTimearray(){
		...
		$intYears = floor($intSeconds / AP_DateTimeSpan::SecondsPerYear);
		$intSeconds = $intSeconds - ($intYears * AP_DateTimeSpan::SecondsPerYear);

		$intMonths = floor($intSeconds / AP_DateTimeSpan::SecondsPerMonth);
		$intSeconds = $intSeconds - ($intMonths * AP_DateTimeSpan::SecondsPerMonth);

		$intDays = floor($intSeconds / AP_DateTimeSpan::SecondsPerDay);
		$intSeconds = $intSeconds - ($intDays * AP_DateTimeSpan::SecondsPerDay);
			
		$intHours = floor($intSeconds / AP_DateTimeSpan::SecondsPerHour);
		$intSeconds = $intSeconds - ($intHours * AP_DateTimeSpan::SecondsPerHour);
			
		$intMinutes = floor($intSeconds / AP_DateTimeSpan::SecondsPerMinute);
		$intSeconds = $intSeconds - ($intMinutes * AP_DateTimeSpan::SecondsPerMinute);
