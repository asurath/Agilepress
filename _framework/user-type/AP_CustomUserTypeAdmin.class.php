...
/**
 * Class for the Admin page to create and maintain the Custom AgilePress User Types and Global AgilePress User Fields
 * 
 * @author AgilePress Core Developement Team
 *
 */
class AP_CustomUserTypeAdmin extends AP_CustomUserTypeBase{
	...
	$mixGlobalFieldArray= AP_CustomUserTypeBase::GetGlobalUserFieldArray();
	$UserTypeArray = AP_CustomUserTypeBase::GetUserTypeArray();
	?>
